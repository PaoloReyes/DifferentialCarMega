    ...
    class JohnsonMotor {
        public:
            JohnsonMotor(uint8_t in1, uint8_t in2, uint8_t pwm);
            JohnsonMotor(uint8_t in1, uint8_t in2, uint8_t pwm, uint8_t enc_a, uint8_t enc_b, double TIMER_S);
            JohnsonMotor(uint8_t in1, uint8_t in2, uint8_t pwm, uint8_t enc_a, uint8_t enc_b, double TIMER_S, double kp, double ki);
